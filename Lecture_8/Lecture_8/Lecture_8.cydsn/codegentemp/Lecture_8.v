// ======================================================================
// Lecture_8.v generated from TopDesign.cysch
// 06/12/2020 at 15:48
...
`ifdef WARP
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\nand_v1_0"
`include "F:\PSoC\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\nand_v1_0\nand_v1_0.v"
`else
`define CY_BLK_DIR "F:\PSoC\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\nand_v1_0"
`include "F:\PSoC\PSoC Creator\4.3\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\nand_v1_0\nand_v1_0.v"
`endif
...
module top ;
    ...
    assign Net_5 = ~(Net_1 & Net_2);


    assign Net_10 = ~(Net_1 & Net_5);


    assign Net_11 = ~(Net_5 & Net_2);


    assign Net_17 = ~(Net_10 & Net_11);
	...
	cy_psoc3_pins_v1_10
		#(.id("1d327e09-1afc-41eb-91a3-3d5982515a85"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("47eb1fa2-0afa-462d-b68e-49b1899ccd56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f058e6bf-ffac-4ae0-83e6-dc59fbfa4f4a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SwitchOut_net;
	wire [0:0] tmpFB_0__SwitchOut_net;
	wire [0:0] tmpIO_0__SwitchOut_net;
	wire [0:0] tmpINTERRUPT_0__SwitchOut_net;
	electrical [0:0] tmpSIOVREF__SwitchOut_net;

	cy_psoc3_pins_v1_10
		#(.id("d5db333e-12b7-4e38-aea7-0f4415ea3491"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SwitchOut
		 (.oe(tmpOE__SwitchOut_net),
		  .y({Net_21}),
		  .fb({tmpFB_0__SwitchOut_net[0:0]}),
		  .io({tmpIO_0__SwitchOut_net[0:0]}),
		  .siovref(tmpSIOVREF__SwitchOut_net),
		  .interrupt({tmpINTERRUPT_0__SwitchOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SwitchOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
